...
<%
    ...
    ResultSet rs 	= st.executeQuery("SELECT idMarket, libelle, dateFin, resultat FROM markets WHERE idMarket<>0 AND ( libelle ILIKE '%" + request.getParameter("search") + "%' OR libelleInverse ILIKE '%" + request.getParameter("search") + "%' ) ORDER BY dateFin DESC;");
